...
\hline
C2 & Permanent link to code/repository used for this code version & \url{https://github.com/marborawski/DSSTowerDefense}  \url{https://github.com/marborawski/TowerDefense}\\
\hline
...
\hline
C6 & Software code languages, tools, and services used & C\verb|#|, Matlab (Octave), Unity \\
\hline
C7 & Compilation requirements, operating environments \& dependencies & \\
\hline
C8 & If available Link to developer documentation/manual &  \url{https://github.com/marborawski/DSSTowerDefense/tree/main/Doc/} \\
\hline
C9 & Support email for questions &  \href{mailto:mariusz.borawski@usz.edu.pl }{mariusz.borawski@usz.edu.pl }  \\
\hline
\end{tabular}
...
\input{MotivationAndSignificance}
\input{SoftwareDescription}
\input{IllustrativeExamples}
\input{Impact}
\input{Conclusions}
